...
func DeletedAt(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtEQ(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDeletedAt), v))
	})
}
...
func DeletedAtNEQ(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtIn(vs ...time.Time) predicate.EntityPermission {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtNotIn(vs ...time.Time) predicate.EntityPermission {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtGT(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtGTE(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtLT(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtLTE(v time.Time) predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtIsNil() predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
...
func DeletedAtNotNil() predicate.EntityPermission {
	return predicate.EntityPermission(func(s *sql.Selector) {
