...
var (
	...
	AttachmentsColumns = []*schema.Column{
		...
		{Name: "relation_type", Type: field.TypeEnum, Enums: []string{"candidate_jobs", "candidate_job_feedbacks", "candidates", "candidate_educates", "candidate_awards", "candidate_certificates", "candidate_notes", "candidate_history_calls"}},
	...
	AuditTrailsColumns = []*schema.Column{
		...
		{Name: "module", Type: field.TypeEnum, Enums: []string{"hiring_teams", "job_positions", "hiring_jobs", "candidates", "skills", "users", "skill_types", "roles", "email_templates", "rec_teams", "candidate_history_calls", "candidate_notes"}},
	...
	CandidatesColumns = []*schema.Column{
		...
		{Name: "reference_value", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	CandidateEducatesColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "school_name", Type: field.TypeString, Size: 2147483647},
		{Name: "major", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "gpa", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	CandidateExpsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "position", Type: field.TypeString, Size: 2147483647},
		{Name: "company", Type: field.TypeString, Size: 2147483647},
		{Name: "location", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "description", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "start_date", Type: field.TypeTime, Nullable: true},
		{Name: "end_date", Type: field.TypeTime, Nullable: true},
	...
	CandidateHistoryCallsColumns = []*schema.Column{
		...
		{Name: "contact_to", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "description", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	CandidateJobsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"applied", "interviewing", "offering", "hired", "failed_cv", "failed_interview", "offer_lost", "ex_staff"}, Default: "applied"},
	...
	HiringJobsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{HiringJobsColumns[22]},
				RefColumns: []*schema.Column{RecTeamsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "hiring_jobs_users_hiring_owner",
				Columns:    []*schema.Column{HiringJobsColumns[23]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "hiring_jobs_users_hiring_job_rec_edges",
				Columns:    []*schema.Column{HiringJobsColumns[24]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
