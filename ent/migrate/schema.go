...
var (
	...
	AuditTrailsColumns = []*schema.Column{
		...
		{Name: "module", Type: field.TypeEnum, Enums: []string{"hiring_teams", "job_positions", "hiring_jobs", "candidates", "skills", "users", "skill_types", "roles", "email_templates", "rec_teams", "candidate_notes"}},
