...
func (c *Candidate) OutgoingEmailEdges(ctx context.Context) (result []*OutgoingEmail, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = c.NamedOutgoingEmailEdges(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = c.Edges.OutgoingEmailEdgesOrErr()
	}
	if IsNotLoaded(err) {
		result, err = c.QueryOutgoingEmailEdges().All(ctx)
	}
	return result, err
}
...
func (chc *CandidateHistoryCall) CreatedByEdge(ctx context.Context) (*User, error) {
	result, err := chc.Edges.CreatedByEdgeOrErr()
	if IsNotLoaded(err) {
		result, err = chc.QueryCreatedByEdge().Only(ctx)
	}
	return result, MaskNotFound(err)
}
...
func (hj *HiringJob) JobPositionEdge(ctx context.Context) (*JobPosition, error) {
	result, err := hj.Edges.JobPositionEdgeOrErr()
	if IsNotLoaded(err) {
		result, err = hj.QueryJobPositionEdge().Only(ctx)
	}
	return result, MaskNotFound(err)
}
...
func (jp *JobPosition) HiringJobPositionEdges(ctx context.Context) (result []*HiringJob, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = jp.NamedHiringJobPositionEdges(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = jp.Edges.HiringJobPositionEdgesOrErr()
	}
	if IsNotLoaded(err) {
		result, err = jp.QueryHiringJobPositionEdges().All(ctx)
	}
	return result, err
}

func (oe *OutgoingEmail) CandidateEdge(ctx context.Context) (*Candidate, error) {
	result, err := oe.Edges.CandidateEdgeOrErr()
	if IsNotLoaded(err) {
...
func (u *User) CandidateHistoryCallEdges(ctx context.Context) (result []*CandidateHistoryCall, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = u.NamedCandidateHistoryCallEdges(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
		result, err = u.Edges.CandidateHistoryCallEdgesOrErr()
	}
	if IsNotLoaded(err) {
		result, err = u.QueryCandidateHistoryCallEdges().All(ctx)
	}
	return result, err
}
