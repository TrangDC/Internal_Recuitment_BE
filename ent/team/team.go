...
const (
	...
	// TeamJobEdgesTable is the table that holds the team_job_edges relation/edge.
	TeamJobEdgesTable = "hiring_jobs"
	// TeamJobEdgesInverseTable is the table name for the HiringJob entity.
