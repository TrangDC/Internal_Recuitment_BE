...
func HasUserEdges() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func HasUserEdgesWith(preds ...predicate.User) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasTeamJobEdges applies the HasEdge predicate on the "team_job_edges" edge.
func HasTeamJobEdges() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TeamJobEdgesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, TeamJobEdgesTable, TeamJobEdgesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTeamJobEdgesWith applies the HasEdge predicate on the "team_job_edges" edge with a given conditions (other predicates).
func HasTeamJobEdgesWith(preds ...predicate.HiringJob) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TeamJobEdgesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, TeamJobEdgesTable, TeamJobEdgesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasMemberEdges applies the HasEdge predicate on the "member_edges" edge.
func HasMemberEdges() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MemberEdgesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, MemberEdgesTable, MemberEdgesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasMemberEdgesWith applies the HasEdge predicate on the "member_edges" edge with a given conditions (other predicates).
func HasMemberEdgesWith(preds ...predicate.User) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MemberEdgesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, MemberEdgesTable, MemberEdgesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasUserTeams() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(UserTeamsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, UserTeamsTable, UserTeamsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasUserTeamsWith(preds ...predicate.TeamManager) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(UserTeamsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, UserTeamsTable, UserTeamsColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
