...
// HasRolePermissionEdges applies the HasEdge predicate on the "role_permission_edges" edge.
func HasRolePermissionEdges() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RolePermissionEdgesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, RolePermissionEdgesTable, RolePermissionEdgesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRolePermissionEdgesWith applies the HasEdge predicate on the "role_permission_edges" edge with a given conditions (other predicates).
func HasRolePermissionEdgesWith(preds ...predicate.EntityPermission) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RolePermissionEdgesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, RolePermissionEdgesTable, RolePermissionEdgesColumn),
		)
...
func HasUserEdges() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUserEdgesWith(preds ...predicate.User) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
